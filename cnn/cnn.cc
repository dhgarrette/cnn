...
const Tensor& ComputationGraph::forward(VariableIndex i) { return ee->forward(i); };
const Tensor& ComputationGraph::incremental_forward(VariableIndex i) { return ee->incremental_forward(i); }
